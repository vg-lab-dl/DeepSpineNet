...
class SegModel(Model):
    def __init__(self, configuration: YAMLConfig):
        ...
        self.pad = configuration.get_entry(['Network', 'pad'], False)
    ...
    def conv3D(self, filters, kernel: Union[int, list, tuple] = (3, 3, 3),
               stride: Union[int, list, tuple] = (1, 1, 1), name=None):

        return Conv3D(filters, kernel_size=kernel, strides=stride, padding=self.padding,
                      kernel_initializer=self.base_init, kernel_regularizer=self.reg_init,
                      activation=self.activation_function, name=name)

    def conv3DT(self, filters, kernel: Union[int, list, tuple] = 2, stride: Union[int, list, tuple] = 2, name=None):
        return Conv3DTranspose(filters, kernel_size=kernel, strides=stride, padding=self.padding,
...
class UNet3D(SegModel):
    def __init__(self, configuration: YAMLConfig):
        ...
        self.conv_0_1 = self.conv3D(self.base_filt, name='conv_0_1')
        self.conv_0_2 = self.conv3D(self.base_filt * 2, name='conv_0_2')
        self.max_0_1 = MaxPool3D(2, 2, name='max_0_1')

        # Level one
        self.conv_1_1 = self.conv3D(self.base_filt * 2, name='conv_1_1')
        self.conv_1_2 = self.conv3D(self.base_filt * 4, name='conv_1_2')
        self.max_1_2 = MaxPool3D(2, 2, name='max_1_2')

        # Level two
        self.conv_2_1 = self.conv3D(self.base_filt * 4, name='conv_2_1')
        self.conv_2_2 = self.conv3D(self.base_filt * 8, name='conv_2_2')
        self.max_2_3 = MaxPool3D(2, 2, name='max_2_3')

        # Level three
        self.conv_3_1 = self.conv3D(self.base_filt * 8, name='conv_3_1')
        self.conv_3_2 = self.conv3D(self.base_filt * 16, name='conv_3_2')

        # Level two
        self.up_conv_3_4 = self.conv3DT(self.base_filt * 16, kernel=2, stride=2, name='up_conv_3_4')
        self.conv_4_1 = self.conv3D(self.base_filt * 8, name='conv_4_1')
        self.conv_4_2 = self.conv3D(self.base_filt * 8, name='conv_4_2')

        # Level one
        self.up_conv_4_5 = self.conv3DT(self.base_filt * 8, kernel=2, stride=2, name='up_conv_4_5')
        self.conv_5_1 = self.conv3D(self.base_filt * 4, name='conv_5_1')
        self.conv_5_2 = self.conv3D(self.base_filt * 4, name='conv_5_2')

        # Level zero
        self.up_conv_5_6 = self.conv3DT(self.base_filt * 4, kernel=2, stride=2, name='up_conv_5_6')
        self.conv_6_1 = self.conv3D(self.base_filt * 2, name='conv_6_1')
        self.conv_6_2 = self.conv3D(self.base_filt * 2, name='conv_6_2')
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        out = self.concat_tensors(conv_2_2, up_conv_3_4)
        ...
        out = self.concat_tensors(conv_1_2, up_conv_4_5)
        ...
        out = self.concat_tensors(conv_0_2, up_conv_5_6)
...
class UNet3DDeep(SegModel):
    def __init__(self, configuration: YAMLConfig):
        ...
        # level four
        self.conv_4_1 = self.conv3D(self.base_filt * 16, name='conv_4_1')
        self.conv_4_2 = self.conv3D(self.base_filt * 32, name='conv_4_2')

        # level three
        self.up_conv_4_5 = self.conv3DT(self.base_filt * 32, kernel=2, stride=2, name='up_conv_4_5')
        self.conv_5_1 = self.conv3D(self.base_filt * 16, name='conv_5_1')
        self.conv_5_2 = self.conv3D(self.base_filt * 16, name='conv_5_2')

        # Level two
        self.up_conv_5_6 = self.conv3DT(self.base_filt * 16, kernel=2, stride=2, name='up_conv_5_6')
        self.conv_6_1 = self.conv3D(self.base_filt * 8, name='conv_6_1')
        self.conv_6_2 = self.conv3D(self.base_filt * 8, name='conv_6_2')

        # Level one
        self.up_conv_6_7 = self.conv3DT(self.base_filt * 8, kernel=2, stride=shallow_n_nstride, name='up_conv_6_7')
        self.conv_7_1 = self.conv3D(self.base_filt * 4, name='conv_7_1')
        self.conv_7_2 = self.conv3D(self.base_filt * 4, name='conv_7_2')

        # Level zero
        self.up_conv_7_8 = self.conv3DT(self.base_filt * 4, kernel=2, stride=shallow_n_nstride, name='up_conv_7_8')
        self.conv_8_1 = self.conv3D(self.base_filt * 2, name='conv_8_1')
        self.conv_8_2 = self.conv3D(self.base_filt * 2, name='conv_8_2')
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        up_conv_4_5 = self.up_conv_4_5(out)
        out = self.concat_tensors(conv_3_2, up_conv_4_5)
        out = self.conv_5_1(out)
        out = self.conv_5_2(out) if not self.use_dropout else self.dropout(self.conv_5_2(out), training)

        up_conv_5_6 = self.up_conv_5_6(out)
        out = self.concat_tensors(conv_2_2, up_conv_5_6)
        out = self.conv_6_1(out)
        out = self.conv_6_2(out) if not self.use_dropout else self.dropout(self.conv_6_2(out), training)

        up_conv_6_7 = self.up_conv_6_7(out)
        out = self.concat_tensors(conv_1_2, up_conv_6_7)
        ...
        out = self.concat_tensors(conv_0_2, up_conv_7_8)
